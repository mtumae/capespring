    ...
    return(
        <>
            ...
            <div className="p-10 text-sm">
                ...
                }} onChange={e => setMsg(e.currentTarget.value)} className=" w-full border border-[#6b6a6a] p-2 focus:outline-0 rounded-lg text-black shadow-sm" placeholder="Leave a comment"></input>}
